...
const PaperSharing = () => {
    return (
        <div className='sharing'>
            ...
            <p>
                Technical papers describing original, previously unpublished research results, experimental or theoretical, are solicited in all areas described above. The template for the conference is available at : https://www.ieee.org/conferences/publishing/templates.html</p>
            <p>
            ...
            <p>
                Authors are invited to submit papers through Microsoft's Conference Management Toolkit (CMT). The authors are invited to submit full papers up to 6 pages through: https://cmt3.research.microsoft.com/ICTEST2025 After logging into the Conference Management System, please click on the “Create new submission” tab and follow the instructions. The Title of the paper and the Abstract are to be entered separately, along with the full paper.
            </p>
            <p>
